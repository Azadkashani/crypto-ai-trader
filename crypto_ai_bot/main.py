"""
Crypto AI Bot v1.2
Main Trading Loop – Testnet / Live
"""
...
from config import (
    API_KEY, API_SECRET,
    SCAN_INTERVAL_MINUTES, MAX_OPEN_TRADES,
    TRAILING_STOP_ENABLED, TRAILING_STOP_ACTIVATION,
    ACCOUNT_BALANCE,
)
...
def main():
    ...
    if TRADING_ENABLED:
        ...
        print("Trading mode: ENABLED (Testnet/Live)")
    else:
    ...
    while True:
        ...
        if not results or not TRADING_ENABLED:
            if results:
        ...
        if order_mgr and order_mgr.check_open_positions():
